    ...
    <MainHeaderStyle>
      ...
      <ItemsHeader>
        <FaceBookContainer>
          ...
          <BsCart style={{ color: "white", fontSize: "20px" }} />
          <Link to="/online" style={{ textDecoration: "none" }}><span style={{ color: "white", fontFamily: "Glyphicons Halflings", fontWeight: "400", fontSize: "10px" }}>Dining Car</span></Link>
        </FaceBookContainer>
        <ItemsContainer>
