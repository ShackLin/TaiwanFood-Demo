...
function SideDishSlider({sides,order}) {
    ...
    const SlidesStyles={    
        ...
        backgroundImage:`url(${sides[currentIndex].url})`
    }
    ...
    const GotoPrev=()=>{
        ...
        const NewIndex=isFirstSlide? sides.length -1:currentIndex -1;
        setCurrentIndex(NewIndex);
    }
    const GotoNext=()=>{
        const isLastSlide=currentIndex===sides.length -1;
