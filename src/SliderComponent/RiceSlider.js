...
function RiceSlider({Rice,order}) {
    ...
    const SlidesStyles={    
        ...
        backgroundImage:`url(${Rice[currentIndex].url})`
    }
    ...
    const GotoPrev=()=>{
        ...
        const NewIndex=isFirstSlide? Rice.length -1:currentIndex -1;
        setCurrentIndex(NewIndex);
    }
    const GotoNext=()=>{
        const isLastSlide=currentIndex===Rice.length -1;
